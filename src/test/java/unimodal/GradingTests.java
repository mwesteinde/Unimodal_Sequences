...
public class GradingTests {
    ...
    @Test
    public void test10() {
        int[] intArray = new int[] { 3, 6, 5, 4, 5, 7, 9, 11, 10, 8, 6, 2, 3, 5, 6, 4 };
        try {
            assertEquals(9, UnimodalSequence.getLength_longestUnimodalSequence(intArray));
        } catch (NoUnimodalSequenceException e) {
            fail("no exception expected");
    ...
    @Test
    public void test11() {
        int[] intArray = new int[] { 6, 7, 8, 9, 10, 11, 12, 13, 17 };
        try {
            assertEquals(9, UnimodalSequence.getLength_longestUnimodalSequence(intArray));
            fail("should have resulted in an exception");
        } catch (NoUnimodalSequenceException e) {
    ...
    @Test
    public void test12() {
        int[] intArray = new int[] { -10, -9, -8, -7, -6, -5, -4, 3, 6, 5, 4, 5, 7, 9, 11, 10, 8, 6, 2, 3, 5, 6, 4 };
        try {
            assertEquals(11, UnimodalSequence.getLength_longestUnimodalSequence(intArray));
        } catch (NoUnimodalSequenceException e) {
            fail("no exception expected");
        }
    }
